...
export default forwardRef(function Input({label, error, rightRender, style, className, hiddenErrorMessage, disabled, success, ...rest}: InputProps, ref: Ref<HTMLInputElement>) {
  /**
