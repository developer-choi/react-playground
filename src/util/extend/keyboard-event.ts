...
export type MinumumSpecialKeyEvent = Record<KeyboardEventSpecialKey, boolean>;
 ...
 */
export function isMatchKeyboardEvent(event: MinimumKeyboardEvent, matchTarget: { key: string, matchKeys?: KeyboardEventSpecialKey[] }) {
...
export function isMatchSpecialKey(event: MinumumSpecialKeyEvent, matchKeys: KeyboardEventSpecialKey[]) {
