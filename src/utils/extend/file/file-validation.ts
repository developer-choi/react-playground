 ...
 * @exception LegacyValidateError 기존에 이미 등록되있던 파일들중 똑같은 파일명이 newFiles에 있는 경우
 */
 ...
 * @exception LegacyValidateError 파일명에 확장자가 없는 경우
 * @exception LegacyValidateError 파일의 확장자가 extensions에 없는 확장자 인 경우
 */
