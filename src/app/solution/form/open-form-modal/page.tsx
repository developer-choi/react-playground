...
/**
 * URL: http://localhost:3000/solution/form/open-form-modal
 * Doc : https://docs.google.com/document/d/1lFkActTl9Htv-WrqX5_-QUb9ffv1OPAdv6rleQ1g_bA/edit#heading=h.de7tdbfb9ae5
...
function AddressModal({data}: ModalProps) {
  const {watch} = useForm<ModalFormData>({
    defaultValues: data // 이부분이 핵심임. 이렇게 셋팅하면 너무편함.
  });
