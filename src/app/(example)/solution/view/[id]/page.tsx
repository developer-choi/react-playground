import {handleServerSideError, validateViewPageIdParams} from '@/utils/service/common/error/server';
import {ApiResponseError, PageServerComponentProps} from '@forworkchoe/core/utils';
...
async function getBoardViewApi(id: number) {
  if (id < 999) {
    ...
    throw new ApiResponseError({} as any, {
      original: {} as any,
      data: {},
      status: 404,
      url: '게시글상세API'
