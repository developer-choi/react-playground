import React, {ChangeEvent, ChangeEventHandler, ComponentPropsWithoutRef, forwardRef, KeyboardEvent, Ref, useCallback} from "react";
...
export default forwardRef(function InputText(props: InputTextProp, ref: Ref<HTMLInputElement>) {
  ...
  return <input ref={ref} type={type} onChange={customOnChange} onKeyDown={customOnKeyDown} autoCapitalize={autoCapitalize} onInvalid={preventDefault} {...rest} />;
});
