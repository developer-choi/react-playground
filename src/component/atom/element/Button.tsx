import React, {ComponentPropsWithoutRef, forwardRef, MouseEvent, MouseEventHandler, Ref, useCallback, useState} from "react";
...
export default forwardRef(function Button(props: ButtonProp, ref: Ref<HTMLButtonElement>) {
  ...
  return <StyledButton ref={ref} type={type} onClick={clickHandler} onClickCapture={clickCaptureHandler} className={classNames({loading: isLoadingResult}, className)} {...rest} />;
});
