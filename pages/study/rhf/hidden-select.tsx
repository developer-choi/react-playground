...
export default function Page() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit, onError)}>
      ...
      <div style={{width: 60, height: 20, background: 'red', color: 'white'}} onClick={() => setValue('select', '1')}>1</div>
      <div style={{width: 60, height: 20, background: 'red', color: 'white'}} onClick={() => setValue('select', '2')}>2</div>
      <div style={{width: 60, height: 20, background: 'red', color: 'white'}} onClick={() => setValue('select', '3')}>3</div>
...
const HiddenSelect = forwardRef(function HiddenSelect(
  { style = DEFAULT_STYLE, values, ...rest }: HiddenSelectProps,
