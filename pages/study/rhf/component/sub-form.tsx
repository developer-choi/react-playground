...
export default function Page() {
  ...
  const setRequiredValue = useCallback(
    (value: string) => {
...
const HiddenInput = forwardRef(function HiddenInput({style = DEFAULT_STYLE, ...rest}: ComponentPropsWithoutRef<"input">, ref: Ref<HTMLInputElement>) {
