 ...
 * 2. 페이지입장 http://localhost:3000/examples/libraries/next/prefetch/start
...
export default function Page() {
  return (
    <Wrap>
      <Link href="/examples/libraries/next/prefetch/some1">
        <a>prefetch 성공용도의 링크 (HOVER ME)</a>
      </Link>

      <Link href="/examples/libraries/next/prefetch/some2">
        <a>prefetch 성공용도의 링크 (HOVER ME)</a>
      </Link>

      <Link href="/examples/libraries/next/prefetch/some3">
        <a>prefetch 실패용도의 링크 (HOVER ME)</a>
      </Link>

      <Link href="/examples/libraries/next/prefetch/server-side">
