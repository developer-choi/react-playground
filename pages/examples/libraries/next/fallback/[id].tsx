...
/**
 * In development, Case 1. http://localhost:3000/examples/libraries/next/fallback/1로 접속할 때
 * ==> fallback true, false, blocking 모두 동일하게 동작함. 1.5초 뒤에 /페이지로 이동됨.
 *
 * In development, Case2. http://localhost:3000/examples/libraries/next/fallback/2로 접속할 때
